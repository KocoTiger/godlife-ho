            ...
            <tr class="profileImg">
               ...
               <tr class="redCardCount">
                  ...
                  <td>
                        ...
                        <button style="WIDTH: 60pt; HEIGHT: 40pt" type="button" class="btn active btn_join" id="useRedCoupon">쿠폰 사용<p style="font-size: 10px;">${user.redCouponCount}장 보유</p></button>
                  </td>
               </tr>
