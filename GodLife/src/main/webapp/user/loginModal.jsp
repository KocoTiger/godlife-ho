...
<meta charset="UTF-8">
<title>로그인</title>
<link rel="stylesheet" href="/resources/css/loginView.css" />
      ...
      <div class="write_form">
         <div class="write_view login_view">
            ...
            <a class = "p-2"  
                                  ...
                                  <img id = "kakao"  src = "/resources/images/uploadFiles/카카오 로그인.png"></a>
         </div>
      </div>
   </div>
</div>
...
$( function() {
   ...
   $("button").on("click" , function() {
      ...
      $("form").attr("method","POST").attr("action","/user/loginModal").attr("target","_parent").submit();
